...
//             } catch (e) {
//               throw new Error(
//                 "Failed to fetch resume: " + (text || response.statusText)
//               );
//             }
//           }
//           // Handle successful response as a blob
//           return response.blob();
//         },
//       }),
//       transformResponse: (response) => {
//         // Only create a blob URL for successful responses
//         if (response instanceof Blob && response.type === "application/pdf") {
//           return URL.createObjectURL(response);
//         }
//         return null; // Return null for non-PDF responses
//       },
//     }),
