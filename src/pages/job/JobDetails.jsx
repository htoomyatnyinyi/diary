...
const JobDetails = ({ job }) => {
  ...
  // console.log(resumes?.data[0].file_name, "check resume at frontedn");

  // #############
  const { data: saveJobStatus, isLoading: isStatusLoading } =
    useGetSavedJobsQuery();

  if (isStatusLoading) return <p>Loading</p>;
  // console.log(saveJobStatus.data);
  // console.log(
  //   saveJobStatus.data.map((e) => console.log(e.id === job?.id)),
  //   "check the status applied or not.",
  //   job?.id
  // );
  // #############
